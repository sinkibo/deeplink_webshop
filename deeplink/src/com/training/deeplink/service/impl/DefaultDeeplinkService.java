...
public class DefaultDeeplinkService implements DeeplinkService {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultDeeplinkService.class);
    ...
    private InputStream getImageStream() {
        return DefaultDeeplinkService.class.getResourceAsStream("/deeplink/sap-hybris-platform.png");
    }

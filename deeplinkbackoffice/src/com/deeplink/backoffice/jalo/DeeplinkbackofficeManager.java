 ...
 */
public class DeeplinkbackofficeManager extends GeneratedDeeplinkbackofficeManager {
    /**
     * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
     */
    private static final Logger LOG = Logger.getLogger(DeeplinkbackofficeManager.class.getName());
     ...
     */
    public static DeeplinkbackofficeManager getInstance() {
        return (DeeplinkbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(DeeplinkbackofficeConstants.EXTENSIONNAME);
    }
     ...
     */
    public DeeplinkbackofficeManager() // NOPMD
    {
        if (LOG.isDebugEnabled()) {
            LOG.debug("constructor of DeeplinkbackofficeManager called.");
        }
    }
